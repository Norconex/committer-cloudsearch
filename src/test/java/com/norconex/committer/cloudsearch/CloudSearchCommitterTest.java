...
/**
 * CloudSearch main tests. Meant to be run locally using
...
class CloudSearchCommitterTest {
    ...
    private CloudSearchCommitter createCloudSearchCommitter()
            throws CommitterException {
        CommitterContext ctx = CommitterContext.builder()
                .setWorkDir(new File(tempDir,
                        "" + TimeIdGenerator.next()).toPath())
                .build();
        CloudSearchCommitter committer = new CloudSearchCommitter();
    ...
    private CloudSearchCommitter withinCommitterSession(CommitterConsumer c)
            throws CommitterException {
        CloudSearchCommitter committer = createCloudSearchCommitter();
        try {
            c.accept(committer);
    ...
    private interface CommitterConsumer {
        void accept(CloudSearchCommitter c) throws Exception;
    }
